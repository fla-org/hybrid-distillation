...
config_dict = {
    "1.5b": {
        ...
        "fuse_norm": True,
        "hidden_act": "swish",  # "silu" in HF, but swish is equivalent
        "hidden_ratio": None,  # Will be computed from intermediate_size/hidden_size if needed
        "hidden_size": 1536,
        ...
        "tie_word_embeddings": True,  # Note: different from 7B!
        "use_cache": True,
        "vocab_size": 151936,
        "max_position_embeddings": 32768,
        "qkv_bias": True,  # Assuming same as 7B
    },
    "7b": {
        "attention_bias": False,
        "bos_token_id": 151643,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default='7b')
    parser.add_argument("--output", default='converted/Qwen2.5-7B-Instruct')
